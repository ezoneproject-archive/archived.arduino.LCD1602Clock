...
// 3.3v power
#define DS1302_SCLK_PIN   9    // Arduino pin for the Serial Clock (SCLK)
#define DS1302_IO_PIN    10    // Arduino pin for the Data I/O     (IO)
#define DS1302_CE_PIN    11    // Arduino pin for the Chip Enable  (RST)
